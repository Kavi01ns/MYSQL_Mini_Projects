...
create procedure GetEmployeesByDepartmentName(IN dept_name VARCHAR(255))
BEGIN
...
BEGIN
    ...
    select  subdate(current_date(),interval age year) into Birth_year
    from employees 
...
-- Call employee 5004
SET @birth_year_5004 = 0;
call FindEmployeeBirthYearByID(5004, @birth_year_5004);
select @birth_year_5004 AS 'Employee 5004 Birth Year';

-- Call employee 5018
SET @birth_year_5018 = 0;
call FindEmployeeBirthYearByID(5018, @birth_year_5018);
select @birth_year_5018 AS 'Employee 5018 Birth Year';

-- Call employee 5029
SET @birth_year_5029 = 0;
call FindEmployeeBirthYearByID(5029, @birth_year_5029);
select @birth_year_5029 AS 'Employee 5029 Birth Year';
